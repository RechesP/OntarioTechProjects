...
with open('Lecture/data/plain_text.txt', 'r') as plain_text_input:
    for line in plain_text_input:
        print(f'"{line.strip()}"')

with open('Lecture/data/plain_text_output.txt', 'w') as plain_text_output:
...
with open('Lecture/data/products.json', 'r') as json_input:
...
with open('Lecture/data/products_sale.json', 'w') as json_output:
...
with open('Lecture/data/midterm_marks_out.csv', 'r') as csv_input:
